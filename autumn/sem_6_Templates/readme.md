...
_Читать подробнее в [2] или просто гуглим._  
...
_Про сборку программы читать в [7]_
```cpp
#include <iostream>
#include "sum.h"  // !!!!
...
3. **Компиляция**:
_Про сборку программы и этапы компиляции читать в [7]_  
...
## Домашнее задани
  - Контест - вам помогут [4] и [5]
  - Задачки:
    1. Напистаь шаблонный swap
    2. Разобраться с работой с двумя файлами
## Полезные ссылки
  - [0] Как обычно хендбук от Яндекса, [тут](https://education.yandex.ru/handbook/cpp/article/templates)
  - [1] [Статья](https://habr.com/ru/articles/599801/) про шаблоны в С++, пока читаем первые 2 пункта.
  - [2] [Ссылка](https://learn.microsoft.com/ru-ru/cpp/cpp/header-files-cpp?view=msvc-170) про разделение на файлы
  - [3] [Ccылка](https://docs.yandex.ru/docs/view?url=ya-disk-public%3A%2F%2F0wun9IkadyqEfdsQreQMAcJHB3%2B2RlVKcS2fyexIVATkzsBdkwW0RlVYDIbHtACCq%2FJ6bpmRyOJonT3VoXnDag%3D%3D%3A%2F2-05%2FIterators.pdf&name=Iterators.pdf&nosw=1) про итераторы
  - [4] [Ccылка](https://en.cppreference.com/w/cpp/algorithm/copy) на std::copy
  - [5] [Ccылка](https://en.cppreference.com/w/cpp/algorithm/fill) на std::fill
  - [6] [Ссылка](https://en.cppreference.com/w/cpp/language/parameter_pack) на шаблоны с переменным числом аргументов
  - [7] [Ссылка](https://habr.com/ru/articles/478124/) про этапы сборки программы
